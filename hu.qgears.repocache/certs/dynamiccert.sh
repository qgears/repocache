...
openssl x509 -in keys/$SITE/site.csr -out public/$SITE/site.cert -req -CA public/repocache.qgears.com.cert -CAkey keys/repocache.qgears.com.private -CAcreateserial -days 365
...
openssl pkcs12 -export -nodes -in public/$SITE/site.cert -inkey keys/$SITE/site.private -out keys/$SITE/site.p12 -name site -CAfile keys/repocache.qgears.com.cert -caname root -passout pass:verysec
